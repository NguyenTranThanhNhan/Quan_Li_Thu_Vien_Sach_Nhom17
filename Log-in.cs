    ...
    public partial class Log_in : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (CheckLogin(name, pass))
            {
                ...
                f.Show();
                this.Hide();
                // sự kiện logout, nếu form chính đắng xuất thì form đăng nhập hiện ra 
                f.LogOut +=F_LogOut;
            }
            else
            {
        ...
        {
            // sender: đối tưởng gửi đi sự kiện
            //isExit: bien ngay nghia la thoat han chuong trinh hay dang xuat
